...
//cu_arr is used to managed an array in gpu memory. cu_arr can reside on the cpu, or it can be cu_obj managed, in which case it resides on the gpu and can be passed into a cuda kernel where it can be used almost like a std::vector
