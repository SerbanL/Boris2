...
template bool cuVEC<cuComplex>::mapmesh_newdims(const cuSZ3& new_n);
...
template void cuVEC<cuComplex>::extract_cuvec(size_t size, cuVEC<cuComplex>& cuvec);
...
template void cuVEC<cuComplex>::load_cuarr(size_t size, cu_arr<cuComplex>& input);
...
template void cuVEC<cuComplex>::store_cuarr(size_t size, cu_arr<cuComplex>& output);
