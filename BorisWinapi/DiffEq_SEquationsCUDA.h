...
__device__ cuReal3 ManagedDiffEqCUDA::SLLG(int idx)
{
...
__device__ cuReal3 ManagedDiffEqCUDA::SLLGSTT(int idx)
{
...
__device__ cuReal3 ManagedDiffEqCUDA::SLLB(int idx)
{
	//gamma = -mu0 * gamma_e = mu0 * g e / 2m_e = 2.212761569e5 m/As
...
__device__ cuReal3 ManagedDiffEqCUDA::SLLBSTT(int idx)
{
	//gamma = -mu0 * gamma_e = mu0 * g e / 2m_e = 2.212761569e5 m/As
