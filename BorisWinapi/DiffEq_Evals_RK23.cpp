...
void DifferentialEquation::RunRK23_Step0_withReductions(void)
{
...
void DifferentialEquation::RunRK23_Step0(void)
{
...
void DifferentialEquation::RunRK23_Step2_withReductions(void)
{
...
void DifferentialEquation::RunRK23_Step2(void)
{
#pragma omp parallel for
	for (int idx = 0; idx < pMesh->n.dim(); idx++) {
