...
class ManagedDiffEqDMCUDA {
	...
	typedef cuReal3(ManagedDiffEqDMCUDA::*pODE_t)(int);
...
public:
	...
	__host__ BError set_pointers(DifferentialEquationDMCUDA* pDiffEqCUDA);
...
public:
	...
	__host__ BError set_pointers(DifferentialEquationDMCUDA* pDiffEqCUDA) { return BError(); }
};
