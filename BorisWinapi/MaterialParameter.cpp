...
{
	reinterpret_cast<cu_obj<MatPCUDA<cuReal, cuReal>>*>(p_cu_obj_mpcuda)->get_managed_object()->set_from_cpu_value(*this);
}
...
{
	reinterpret_cast<cu_obj<MatPCUDA<cuReal2, cuReal>>*>(p_cu_obj_mpcuda)->get_managed_object()->set_from_cpu_value(*this);
}
...
{
	reinterpret_cast<cu_obj<MatPCUDA<cuReal3, cuReal>>*>(p_cu_obj_mpcuda)->get_managed_object()->set_from_cpu_value(*this);
}
...
{
	reinterpret_cast<cu_obj<MatPCUDA<cuReal, cuReal>>*>(p_cu_obj_mpcuda)->get_managed_object()->set_from_cpu(*this);
}
...
{
	reinterpret_cast<cu_obj<MatPCUDA<cuReal2, cuReal>>*>(p_cu_obj_mpcuda)->get_managed_object()->set_from_cpu(*this);
}
...
{
	reinterpret_cast<cu_obj<MatPCUDA<cuReal3, cuReal>>*>(p_cu_obj_mpcuda)->get_managed_object()->set_from_cpu(*this);
}
