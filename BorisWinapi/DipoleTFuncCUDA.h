...
__device__ inline cuReal fx(cuReal3 xyz, cuReal3 abc)
{
...
__device__ inline cuReal fy(cuReal3 xyz, cuReal3 abc)
{
...
__device__ inline cuReal fz(cuReal3 xyz, cuReal3 abc)
{
...
__device__ inline cuReal Nxx(cuReal3 xyz, cuReal3 abc)
{
	...
	return sum_this / (4 * (cuReal)PI);
}

__device__ inline cuReal Nyy(cuReal3 xyz, cuReal3 abc)
{
	cuReal sum_this;
...
__device__ inline cuReal Nzz(cuReal3 xyz, cuReal3 abc)
{
	cuReal sum_this;
...
__device__ inline cuReal Nxy(cuReal3 xyz, cuReal3 abc)
{
	cuReal sum_this = 0.0;

	cuReal val = Fxy(xyz, abc);
...
__device__ inline cuReal Nxz(cuReal3 xyz, cuReal3 abc)
{
	cuReal sum_this = 0.0;

	cuReal val = Fxz(xyz, abc);
	if (val) sum_this = log(val);
...
__device__ inline cuReal Nyz(cuReal3 xyz, cuReal3 abc)
{
	cuReal sum_this = 0.0;

	cuReal val = Fyz(xyz, abc);
	if (val) sum_this = log(val);
