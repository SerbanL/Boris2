...
//AVERAGED INPUTS, SINGLE OUTPUT
template <typename Kernel>
double Convolution<Kernel>::Convolute_2D(VEC<DBL3> &In1, VEC<DBL3> &In2, VEC<DBL3> &Out, bool clearOut)
{
	//2D
...
//AVERAGED INPUTS, DUPLICATED OUTPUTS
template <typename Kernel>
double Convolution<Kernel>::Convolute_2D(VEC<DBL3> &In1, VEC<DBL3> &In2, VEC<DBL3> &Out1, VEC<DBL3> &Out2, bool clearOut)
{
	//2D
...
//AVERAGED INPUTS, SINGLE OUTPUT
template <typename Kernel>
double Convolution<Kernel>::Convolute_3D(VEC<DBL3> &In1, VEC<DBL3> &In2, VEC<DBL3> &Out, bool clearOut)
{
	//1. FFTs along x
	for (int k = 0; k < n.z; k++) {
#pragma omp parallel for
...
//AVERAGED INPUTS, DUPLICATED OUTPUTS
template <typename Kernel>
double Convolution<Kernel>::Convolute_3D(VEC<DBL3> &In1, VEC<DBL3> &In2, VEC<DBL3> &Out1, VEC<DBL3> &Out2, bool clearOut)
{
	//1. FFTs along x
	for (int k = 0; k < n.z; k++) {
#pragma omp parallel for
...
//1. Forward (In -> F)
template <typename Kernel>
void Convolution<Kernel>::ForwardFFT_2D(VEC<DBL3> &In1, VEC<DBL3> &In2)
{
	//2D
...
//3. Inverse. Return dot product of In with Out. (F2 -> Out)
template <typename Kernel>
double Convolution<Kernel>::InverseFFT_2D(VEC<DBL3> &In1, VEC<DBL3> &In2, VEC<DBL3> &Out, bool clearOut)
{
	//1. IFFTs along y
#pragma omp parallel for
	for (int i = 0; i < (N.x / 2 + 1); i++) {
...
//3. Inverse. Return dot product of In with Out. (F2 -> Out)
template <typename Kernel>
double Convolution<Kernel>::InverseFFT_2D(VEC<DBL3> &In1, VEC<DBL3> &In2, VEC<DBL3> &Out1, VEC<DBL3> &Out2, bool clearOut)
{
	//1. IFFTs along y
#pragma omp parallel for
	for (int i = 0; i < (N.x / 2 + 1); i++) {
...
//1. Forward (In -> F)
template <typename Kernel>
void Convolution<Kernel>::ForwardFFT_3D(VEC<DBL3> &In1, VEC<DBL3> &In2)
{
	//1. FFTs along x
	for (int k = 0; k < n.z; k++) {
#pragma omp parallel for
...
//3. Inverse. Return dot product of In with Out. (F2 -> Out)
template <typename Kernel>
double Convolution<Kernel>::InverseFFT_3D(VEC<DBL3> &In1, VEC<DBL3> &In2, VEC<DBL3> &Out, bool clearOut)
{
	//1. IFFTs along z
#pragma omp parallel for
	for (int j = 0; j < N.y; j++) {
...
//3. Inverse. Return dot product of In with Out. (F2 -> Out)
template <typename Kernel>
double Convolution<Kernel>::InverseFFT_3D(VEC<DBL3> &In1, VEC<DBL3> &In2, VEC<DBL3> &Out1, VEC<DBL3> &Out2, bool clearOut)
{
	//1. IFFTs along z
#pragma omp parallel for
	for (int j = 0; j < N.y; j++) {
