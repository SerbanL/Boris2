...
MetalMesh::MetalMesh(SuperMesh *pSMesh_) :
	...
	ProgramStateNames(this,
		{
			//Mesh members
			VINFO(meshType), VINFO(meshIdCounter), VINFO(meshId), VINFO(displayedPhysicalQuantity), VINFO(displayedParamVar), VINFO(meshRect), VINFO(n_e), VINFO(h_e), VINFO(n_t), VINFO(h_t), VINFO(V), VINFO(S), VINFO(elC), VINFO(Temp), VINFO(pMod),
			//Members in this derived class

			//Material Parameters
			VINFO(elecCond), VINFO(De), VINFO(SHA), VINFO(iSHA), VINFO(l_sf), VINFO(Gi), VINFO(Gmix), VINFO(base_temperature), VINFO(thermCond), VINFO(density), VINFO(shc)
		},
		{
