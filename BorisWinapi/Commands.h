...
enum CMD_
{
	...
	CMD_ADDFMESH, CMD_ADDAFMESH, CMD_ADDDIPOLEMESH, CMD_ADDMETALMESH, CMD_ADDINSULATORMESH, CMD_ADDDIAMAGNETICMESH,
	CMD_DELMESH, CMD_RENAMEMESH, CMD_MESHFOCUS, CMD_MESHFOCUS2, CMD_MESH, CMD_MESHRECT, CMD_SCALEMESHRECTS, CMD_CELLSIZE, CMD_ECELLSIZE, CMD_TCELLSIZE, CMD_MCELLSIZE, CMD_SCELLSIZE, CMD_FMSCELLSIZE, CMD_ESCELLSIZE,
	CMD_DELRECT, CMD_ADDRECT, CMD_RESETMESH, CMD_LOADMASKFILE, CMD_INDIVIDUALMASKSHAPE,
	CMD_SETANGLE, CMD_INVERTMAG, CMD_SETRECT, CMD_DWALL, CMD_VORTEX, CMD_SKYRMION, CMD_SKYRMIONBLOCH, CMD_RANDOM,
	CMD_PBC,
	...
	CMD_ODE, CMD_SETODE, CMD_SETDT, CMD_ASTEPCTRL, CMD_EVALSPEEDUP,
	CMD_SHOWDATA,
	...
	CMD_DISPLAY, CMD_DISPLAYBACKGROUND, CMD_VECREP, CMD_SAVEMESHIMAGE, CMD_MAKEVIDEO, CMD_IMAGECROPPING, CMD_DISPLAYTRANSPARENCY, CMD_DISPLAYTHRESHOLDS, CMD_DISPLAYTHRESHOLDTRIGGER,
	...
	CMD_STOCHASTIC, CMD_LINKSTOCHASTIC,
	CMD_CUDA, CMD_MEMORY,
	CMD_OPENMANUAL,
	...
	CMD_DP_CLEARALL, CMD_DP_CLEAR, CMD_DP_SHOWSIZES, CMD_DP_GET, CMD_DP_SET, CMD_DP_LOAD, CMD_DP_SAVE, 
	CMD_DP_GETPROFILE, CMD_DP_GETPATH, CMD_GETVALUE, CMD_AVERAGEMESHRECT, CMD_DP_TOPOCHARGE, CMD_DP_HISTOGRAM,
	...
	CMD_DP_DUMPTDEP,
	CMD_DP_FITLORENTZ, CMD_DP_FITSKYRMION, CMD_DP_FITSTT, CMD_DP_FITSOT, CMD_DP_FITSOTSTT, CMD_DP_CALCSOT, CMD_DP_FITADIABATIC, CMD_DP_FITNONADIABATIC,
