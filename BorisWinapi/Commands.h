...
enum CMD_
{
	...
	CMD_DISPLAY, CMD_VECREP, CMD_SAVEMESHIMAGE, CMD_MAKEVIDEO, CMD_IMAGECROPPING,
	...
	CMD_LOADOVF2MESH, CMD_LOADOVF2MAG, CMD_SAVEOVF2MAG, CMD_SAVEOVF2PARAMVAR,
	...
	CMD_DP_GETPROFILE, CMD_DP_AVERAGEMESHRECT, CMD_DP_TOPOCHARGE,
