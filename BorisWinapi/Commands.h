...
enum CMD_
{
	...
	CMD_SETANGLE, CMD_INVERTMAG, CMD_SETRECT, CMD_DWALL, CMD_SKYRMION, CMD_SKYRMIONBLOCH, CMD_RANDOM,
	CMD_PBC,
	CMD_SETFIELD,
	CMD_MODULES, CMD_ADDMODULE, CMD_DELMODULE,
	CMD_MULTICONV, CMD_2DMULTICONV, CMD_NCOMMONSTATUS, CMD_NCOMMON,
	CMD_ODE, CMD_SETODE, CMD_SETDT, CMD_ASTEPCTRL, 
	CMD_SHOWDATA,
	...
	CMD_MOVINGMESH, CMD_MOVINGMESHASYM, CMD_MOVINGMESHTHRESH, CMD_PREPAREMOVINGMESH, CMD_PREPAREMOVINGBLOCHMESH, CMD_PREPAREMOVINGNEELMESH, CMD_PREPAREMOVINGSKYRMIONMESH, CMD_COUPLETODIPOLES, CMD_EXCHANGECOUPLEDMESHES,
	...
	CMD_TSOLVERCONFIG, CMD_SSOLVERCONFIG, CMD_SETFIXEDSOR, CMD_SETSORDAMPING, CMD_STATICTRANSPORTSOLVER,
	...
	CMD_LOADOVF2MESH, CMD_LOADOVF2MAG, CMD_SAVEOVF2MAG,
	...
	CMD_DP_DUMPTDEP,
	CMD_DP_FITLORENTZ, CMD_DP_FITSKYRMION,
