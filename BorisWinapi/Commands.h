...
enum CMD_
{
	...
	CMD_ADDFMESH, CMD_ADDAFMESH, CMD_ADDDIPOLEMESH, CMD_ADDMETALMESH, CMD_ADDINSULATORMESH,
	CMD_DELMESH, CMD_RENAMEMESH, CMD_MESHFOCUS, CMD_MESHFOCUS2, CMD_MESH, CMD_MESHRECT, CMD_SCALEMESHRECTS, CMD_CELLSIZE, CMD_ECELLSIZE, CMD_TCELLSIZE, CMD_MCELLSIZE, CMD_FMSCELLSIZE, CMD_ESCELLSIZE,
	...
	CMD_DP_GETPROFILE, CMD_DP_GETPATH, CMD_GETVALUE, CMD_AVERAGEMESHRECT, CMD_DP_TOPOCHARGE,
