...
enum CMD_
{
	...
	CMD_ODE, CMD_SETODE, CMD_SETATOMODE, CMD_SETDT, CMD_ASTEPCTRL, CMD_EVALSPEEDUP,
	CMD_SHOWDATA,
	...
	CMD_DP_GETPROFILE, CMD_DP_GETPATH, CMD_GETVALUE, CMD_AVERAGEMESHRECT, CMD_DP_TOPOCHARGE, CMD_DP_COUNTSKYRMIONS, CMD_DP_HISTOGRAM,
