...
#now run
ns.Hequation([Py, '0, He * sinc(kc*(x-Lx/2))*sinc(kc*(y-Ly/2))*sinc(2*PI*fc*(t-t0)), H0', 'time', total_time], custom_data_save, 0.0)
...
plt.axes(xlabel = 'k (rad/m)', ylabel = 'f (Hz)', title = 'Forward Volume')
...
plt.savefig('forwardvolume.png', dpi = 600)
plt.show()