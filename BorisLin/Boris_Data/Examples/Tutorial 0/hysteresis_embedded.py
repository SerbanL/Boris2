...
Example of a hysteresis loop using an embedded Python script, used to save images when magnetization switching is detected.
"""
...
ns.Hpolar_seq([Py, [-100e3, 90, 1, +100e3, 90, 1, 100], 'mxh', 1e-5, 'step'], save_coercivity_image, -800e3)
ns.Hpolar_seq([Py, [100e3, 90, 1, -100e3, 90, 1, 100], 'mxh', 1e-5, 'step'], save_coercivity_image, 800e3)
