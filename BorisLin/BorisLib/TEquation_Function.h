...
namespace EqComp {
	...
	private:
		...
		//ceil
		double F_ceil(BVarType... bvars) const
		{
			return ceil(pFunc1->func(*pFunc1, bvars...));
		}

		double F_ceil_pmul(BVarType... bvars) const
		{
			return param * ceil(pFunc1->func(*pFunc1, bvars...));
		}

		//floor
		double F_floor(BVarType... bvars) const
		{
			return floor(pFunc1->func(*pFunc1, bvars...));
		}

		double F_floor_pmul(BVarType... bvars) const
		{
			return param * floor(pFunc1->func(*pFunc1, bvars...));
		}

		//round
		double F_round(BVarType... bvars) const
		{
			return round(pFunc1->func(*pFunc1, bvars...));
		}

		double F_round_pmul(BVarType... bvars) const
		{
			return param * round(pFunc1->func(*pFunc1, bvars...));
		}
	...
	public:
			...
			varvec(variables)
		{
			...
			case FUNC_SGN_PMUL:
				func = &Function::F_sgn_pmul;
				break;

			case FUNC_CEIL:
				func = &Function::F_ceil;
				break;

			case FUNC_CEIL_PMUL:
				func = &Function::F_ceil_pmul;
				break;

			case FUNC_FLOOR:
				func = &Function::F_floor;
				break;

			case FUNC_FLOOR_PMUL:
				func = &Function::F_floor_pmul;
				break;

			case FUNC_ROUND:
				func = &Function::F_round;
				break;

			case FUNC_ROUND_PMUL:
				func = &Function::F_round_pmul;
				break;
