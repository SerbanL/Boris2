...
//update parameters in the list for spatial dependence only
template <typename PType, typename SType, typename ... MeshParam_List>
void Mesh::update_parameters_scoarse_spatial(int scell_idx, MatP<PType, SType>& matp, PType& matp_value, MeshParam_List& ... params)
{
	if (matp.is_sdep()) {
...
//update parameters in the list for spatial dependence only - single parameter version; position not calculated
template <typename PType, typename SType>
void Mesh::update_parameters_scoarse_spatial(int scell_idx, MatP<PType, SType>& matp, PType& matp_value)
{
...
//update parameters in the list for spatial dependence only
template <typename PType, typename SType, typename ... MeshParam_List>
void Mesh::update_parameters_scoarse_full(int scell_idx, MatP<PType, SType>& matp, PType& matp_value, MeshParam_List& ... params)
{
	if (matp.is_sdep()) {
...
//update parameters in the list for spatial dependence only - single parameter version
template <typename PType, typename SType>
void Mesh::update_parameters_scoarse_full(int scell_idx, MatP<PType, SType>& matp, PType& matp_value)
{
	if (matp.is_sdep()) {
...
template <typename ... MeshParam_List>
void Mesh::update_parameters_scoarse(int scell_idx, MeshParam_List& ... params)
{
	if (Temp.linear_size()) {
