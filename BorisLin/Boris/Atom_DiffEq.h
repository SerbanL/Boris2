...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
// Abstract base class for Atom_DifferentialEquation type objects : used in atomistic meshes
//
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

class Atom_DifferentialEquation : 
	public Atom_ODECommon 
{
	friend Atom_ODECommon;
	friend ODECommon_Base;

#if COMPILECUDA == 1
	friend Atom_DifferentialEquationCUDA;
	friend Atom_DifferentialEquationCubicCUDA;
#endif
...
protected:
	...
	//Used to save starting atomic moments - all evaluation methods do this, even when not needed by the method itself
	VEC<DBL3> sM1;
	...
	Atom_DifferentialEquationCUDA *pameshODECUDA = nullptr;
#endif
...
protected:
	...
	//---------------------------------------- EQUATIONS : Atom_DiffEq_Equations.cpp and Atom_DiffEq_SEquations.cpp
...
public:  //public methods
	...
	Atom_DifferentialEquation(void) :
		Atom_ODECommon(true),
		prng(GetSystemTickCount())
	{}

	Atom_DifferentialEquation(Atom_Mesh *paMesh);
	virtual ~Atom_DifferentialEquation();
	...
	Atom_DifferentialEquationCUDA* Get_DifferentialEquationCUDA_ptr(void) { return pameshODECUDA; }
#endif
};