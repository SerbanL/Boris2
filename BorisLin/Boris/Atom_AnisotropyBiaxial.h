...
//Biaxial anisotropy for an atomistic simple cubic mesh

class Atom_Anisotropy_Biaxial :
	public Modules,
	public ProgramState<Atom_Anisotropy_Biaxial, std::tuple<>, std::tuple<>>
{
private:
...
public:
	...
	Atom_Anisotropy_Biaxial(Atom_Mesh *paMesh_);
	~Atom_Anisotropy_Biaxial() {}
