...
enum CMD_
{
	...
	CMD_SETANGLE, CMD_SETOBJECTANGLE, CMD_INVERTMAG, CMD_MIRRORMAG, CMD_SETRECT, CMD_DWALL, CMD_VORTEX, CMD_SKYRMION, CMD_SKYRMIONBLOCH, CMD_RANDOM, CMD_RANDOMXY, CMD_FLOWER, CMD_ONION, CMD_CROSSTIE,
	CMD_PBC,
	CMD_SETFIELD, CMD_SETSTRESS,
	CMD_MODULES, CMD_ADDMODULE, CMD_DELMODULE,
	CMD_MULTICONV, CMD_2DMULTICONV, CMD_NCOMMONSTATUS, CMD_NCOMMON, CMD_EXCLUDEMULTICONVDEMAG, CMD_GPUKERNELS,
	...
	CMD_DISPLAY, CMD_DISPLAYDETAILLEVEL, CMD_DISPLAYRENDERTHRESH, CMD_DISPLAYBACKGROUND, CMD_VECREP, CMD_SAVEMESHIMAGE, CMD_SAVEIMAGE, CMD_MAKEVIDEO, CMD_IMAGECROPPING, CMD_DISPLAYTRANSPARENCY, CMD_DISPLAYTHRESHOLDS, CMD_DISPLAYTHRESHOLDTRIGGER, CMD_DISPLAYMODULE,
	...
	CMD_DP_GETPROFILE, CMD_DP_GETEXACTPROFILE, CMD_DP_GETAVERAGEDPROFILE, CMD_AVERAGEMESHRECT, CMD_DP_TOPOCHARGE, CMD_DP_COUNTSKYRMIONS, CMD_DP_HISTOGRAM, CMD_DP_THAVHISTOGRAM, CMD_DP_ANGHISTOGRAM, CMD_DP_THAVANGHISTOGRAM, CMD_DP_HISTOGRAM2, CMD_AVERAGECHUNKEDMAGLENGTH,
