...
enum CMD_
{
	...
	CMD_DISPLAY, CMD_DISPLAYDETAILLEVEL, CMD_DISPLAYRENDERTHRESH, CMD_DISPLAYBACKGROUND, CMD_VECREP, CMD_SAVEMESHIMAGE, CMD_MAKEVIDEO, CMD_IMAGECROPPING, CMD_DISPLAYTRANSPARENCY, CMD_DISPLAYTHRESHOLDS, CMD_DISPLAYTHRESHOLDTRIGGER, CMD_DISPLAYMODULE,
	...
	CMD_MCSERIAL, CMD_MCCONSTRAIN, CMD_MCCOMPUTEFIELDS, CMD_MCCONEANGLELIMITS,
	//shape modifiers
	...
	CMD_DP_GETPROFILE, CMD_DP_GETEXACTPROFILE, CMD_GETVALUE, CMD_AVERAGEMESHRECT, CMD_DP_TOPOCHARGE, CMD_DP_COUNTSKYRMIONS, CMD_DP_HISTOGRAM, CMD_DP_HISTOGRAM2,
	...
	CMD_DP_MINMAX, CMD_DP_MEAN, CMD_DP_CHUNKEDSTD, CMD_DP_GETAMPLI,
