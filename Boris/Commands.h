...
enum CMD_
{
	...
	CMD_ADDFMESH, CMD_SETFMESH, CMD_ADDAFMESH, CMD_SETAFMESH, CMD_ADDDIPOLEMESH, 
	CMD_ADDMETALMESH, CMD_ADDINSULATORMESH,
	...
	CMD_SETPOTENTIAL, CMD_SETCURRENT, CMD_SETCURRENTDENSITY,
