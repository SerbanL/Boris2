...
BError Atom_Mesh::RoughenMeshSides(string side, double depth, int seed)
{
	BError error(__FUNCTION__);
...
BError Atom_Mesh::RoughenMeshSurfaces_Jagged(double depth, double spacing, int seed, string sides)
{
	BError error(__FUNCTION__);
