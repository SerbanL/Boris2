...
enum DATA_
{
	...
	DATA_RESPUMP = 50, DATA_IMSPUMP = 51, DATA_RESPUMP2 = 52, DATA_IMSPUMP2 = 53,
	...
	//Energies
	DATA_E_DEMAG = 20, DATA_E_EXCH = 21, DATA_E_SURFEXCH = 22, DATA_E_ZEE = 23, DATA_E_ANIS = 24, DATA_E_ROUGH = 25, DATA_E_MOPTICAL = 49, DATA_E_MELASTIC = 37, DATA_E_TOTAL = 33,
	
	//Torques
	DATA_T_EXCH = 55, DATA_T_SURFEXCH = 54, DATA_T_ZEE = 56, DATA_T_ANIS = 57,
