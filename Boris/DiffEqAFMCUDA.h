...
public:
	...
	cu_obj<ManagedDiffEqAFMCUDA>& Get_ManagedDiffEqCUDA(void) { return cuDiffEq; }
};
...
public:
	...
	DifferentialEquationAFMCUDA(DifferentialEquation *pmeshODE) : DifferentialEquationCUDA() {}
	~DifferentialEquationAFMCUDA() {}
