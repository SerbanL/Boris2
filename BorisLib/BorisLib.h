...
#include "VEC_nprops.h"		//extends VEC (don't count it as higher order)
...
#include "VEC_VC_nprops.h"		//extends VEC_VC (don't count it as higher order)
...
#include "VEC_VC_ngbrsum.h"		//extends VEC_VC (don't count it as higher order)
