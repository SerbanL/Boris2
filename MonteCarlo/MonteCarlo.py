...
class MonteCarlo:
    ...
    iter_avrg_dw = [12500, 12500, 12500, 12500, 15000, 30000, 10000, 10000, 3000, 3000]
    iter_avrg_dw_ref = [12500, 12500, 12500, 12500, 15000, 30000, 10000, 10000, 3000, 3000]
    ...
    def __sweep_temperature_up(self, 
                               ...
                               Tmax_dw = 0.0, get_domainwall = False):
    ...
    def __run_MC_classical(self,
        ...
        self.ns.setangle(direction_deg[0], direction_deg[1])
