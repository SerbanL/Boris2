...
#standard problem set values for Equation (5) as stated on https://www.ctcms.nist.gov/~rdm/mumag.org.html
#I believe there must be a mistake on that webpage as the three propsed sets are not equivalent
#set for Equation (5) should be (similarly for Equation (3)):
u_beta = [[-72.35, 0.0], [-72.35, 0.05], [-72.35, 0.1], [-72.35, 0.5]]
